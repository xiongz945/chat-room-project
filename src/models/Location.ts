...
export interface ILocationModel extends Model<ILocationDocument> {
    ...
    createNewLocation(name: string, location: string, placeID: string, status: string, desc:string): ILocationDocument;
}
...
export const Location: ILocationModel = mongoose.model<ILocationDocument, ILocationModel>('Location', locationSchema);